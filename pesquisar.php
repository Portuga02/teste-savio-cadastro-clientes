...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<form method="POST" class="form-inline" action="">
			...
			<input id="input-busca" class="form-control mr-sm-2" name="con_nome" type="search" placeholder="buscar" aria-label="Search">
	...
	for ($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++) {
		if ($pag_ant >= 1) {
			echo "<a class='btn btn-primary'  role='button' href='pesquisar.php?pagina=$pag_ant'>$pag_ant</a> ";
		}
	}
	...
	for ($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++) {
		if ($pag_dep <= $quantidade_pg) {
			echo "<a class='btn btn-primary'  role='button' href='pesquisar.php?pagina=$pag_dep'>$pag_dep</a> ";
		}
	}

	echo "<a class='btn btn-primary'  role='button' href='pesquisar.php?pagina=$quantidade_pg'>Ultima</a>";

	?>
	<script src="assets/js/scriptPesquisa.js"></script>
